...
INSERT INTO `itemproduto` (`compracod`,`produto`,`preco`,`quantidade`) VALUES 
 (337,3,'0.00',2),
 (337,4,'0.00',2),
 (337,8,'0.00',4),
 (338,4,'12.50',1),
...
CREATE TABLE `listacompras` (
  ...
  `supermercado` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`codigo`),
  KEY `FK_listacompras_usuario` (`usuariocod`),
  KEY `FK_listacompras_super` (`supermercado`),
  CONSTRAINT `FK_listacompras_super` FOREIGN KEY (`supermercado`) REFERENCES `supermercado` (`codigo`) ON DELETE CASCADE,
...
INSERT INTO `listacompras` (`codigo`,`usuariocod`,`datahora`,`supermercado`) VALUES 
 (337,13,'2019-06-03 00:30:07',16),
 (338,13,'2019-06-03 00:32:29',16),
 (339,13,'2019-06-03 00:38:55',16),
 (340,13,'2019-06-03 00:38:57',16),
 (341,13,'2019-06-03 00:43:55',16),
 (342,13,'2019-06-03 00:44:50',16),
 (343,13,'2019-06-03 00:47:30',16);
